...
export function renderListingRow(listing: RankedListing, now?: Date): string {
  ...
  const coverHop = isCover
    ? html`<p class="cover-hop-wrap" data-take-after-list="">
        <a class="cover-hop cover-hop-first take-after-list-first take-after-list-two take-after-list-three" href="${href}" data-cover-hop="" data-first-click="take" data-take-after-list-first="" data-take-after-list-two="" data-take-after-list-three="" aria-label="Test this today at ${host}">Test this today</a>
      </p>`
    : "";
  const listAfterTake = isCover
    ? html`<p class="list-after-take-wrap">
        <a class="list-after-take list-after-take-first list-after-take-two list-after-take-three list-after-take-four" href="#claim" data-list-after-take="" data-first-write="list" data-list-after-take-two="" data-list-after-take-three="" data-list-after-take-four="">List a product</a>
