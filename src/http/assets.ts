...
const INDEXNOW_KEY = "6ece41429162a3c5057f5c05443a55dc";
const ICONS = new Set([
  "brand-mark.svg",
  "brand-mark.png",
  "bitcoin.svg",
...
export const assetRoutes: FastifyPluginAsync = async (app) => {
  ...
  app.get("/robots.txt", async (_request, reply) =>
    reply
      ...
      .type("text/plain; charset=utf-8")
      .send("User-agent: *\nAllow: /\nDisallow: /checkout/\nDisallow: /go/\nSitemap: https://dtcpicks.lol/sitemap.xml\n"),
  );
  ...
  app.get("/sitemap.xml", async (_request, reply) =>
    reply
      ...
      .send('<?xml version="1.0" encoding="UTF-8"?><urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"><url><loc>https://dtcpicks.lol</loc><changefreq>daily</changefreq><priority>1.0</priority></url><url><loc>https://dtcpicks.lol/about</loc><changefreq>monthly</changefreq></url><url><loc>https://dtcpicks.lol/rules</loc><changefreq>monthly</changefreq></url></urlset>'),
  );
  ...
  app.get("/site.webmanifest", async (_request, reply) =>
    reply
      ...
      .send({ name: "DTC Picks Daily", short_name: "DTC Picks", start_url: "/", display: "standalone", background_color: "#f4efe4", theme_color: "#a44725", icons: [{ src: "/icons/brand-mark.png", sizes: "512x512", type: "image/png" }] }),
  );
};
